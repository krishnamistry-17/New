    ...
    <div className='h-[730px] sm:ml-[66px] xs:ml-[12px]'>
      {product ? (
        <div className='flex flex-col md:flex-row'>
          ...
          md:w-[400px] md:h-[350px]'>
            <div className='flex'>
              ...
              {/* Right Image */}
              <div className='sm:mt-0 xs:mt-[53px] 
               ...
               bg-cream-bglight'>
                ...
                md:pt-[25px] sm:pt-[30px] xs:pt-[27px]'>
                  ...
                  lg:w-[400px] lg:h-[356px]
                   md:w-[315px] md:h-[330px]' src={product.image} alt={product.heading} />
                </div>
              </div>
            </div>
          </div>
           ...
           xl:ml-[82px] lg:ml-[42px] md:ml-[24px]'>
            ...
            <div>
              ...
              <div className='flex'>
                ...
                lg:text-[18px] md:text-[16px]'>{product.discount}</p>
              </div>
              ...
              <div className="w-[123px] h-[63px] mt-[18px]">
                ...
                <div className="flex mt-[12px]">
                  ...
                  md:w-[30px] md:h-[30px]
                  xs:w-[25px] xs:h-[25px]
                  bg-purple-light rounded-full"></div>
                  <div className="ml-[16px] 
                  md:w-[30px] md:h-[30px]
                  xs:w-[25px] xs:h-[25px]
                  bg-black-darkest rounded-full"></div>
                  <div className="ml-[16px]
                    md:w-[30px] md:h-[30px]
                  xs:w-[25px] xs:h-[25px]
                  bg-yellow-dark rounded-full"></div>
                </div>
              </div>
        ...
        >
          <p
            className="
              lg:py-[17px] xs:py-[12px] md:py-[10px]
              lg:px-[48px] xs:px-[34px] md:px-[30px]
              lg:text-[20px] md:text-[14px] xs:text-[12px] text-black-darkest"
          >
            Add To Cart
          </p>
        </div>
