  ...
  return (
     <div className='relative w-full'>
           ...
           <img src={logo} alt='applogo' className='w-[77px] h-[77px] md:ml-[30px]  md:mb-[-32px]'></img>
               <h2 className='font-medium md:text-[48px] xs:text-[30px] text-black-darkest'>Checkout</h2>
               <div className=' absolute flex items-center justify-center '>
                   ...
                   <p className='md:text-[16px] xs:text-[12px] text-black-darkest pl-[6.08px]'>Checkout</p>
               </div>
           </div>
       </div>
  )
