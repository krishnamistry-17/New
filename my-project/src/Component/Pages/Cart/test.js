      ...
      ">
        ...
        <div className="md:hidden">
          {cartItems.map((item, index) => (
            <div
              key={index}
              className="bg-cream-bglight p-4 mb-4 rounded-lg shadow-md flex items-center">
              <img
                src={item.image}
                alt={item.heading}
              ...
              <div className="ml-4 flex-grow">
                <p className="text-black-darkest font-medium">{item.heading}</p>
          ...
          <div className="bg-white p-4 rounded-lg shadow-md mt-4 text-center">
            <p className="text-black-darkest font-medium text-lg">
              Subtotal: Rs.{" "}
            ...
            <button className="mt-2 bg-black-darkest text-white px-4 py-2 rounded-lg">
              Proceed to Checkout
            </button>
          </div>
        </div>
