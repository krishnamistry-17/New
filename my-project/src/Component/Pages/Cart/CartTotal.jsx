  ...
  return (
    <div className="bg-white-light h-[700px] font-poppins">
      <div className=" hidden md:block">
        <div
          className="bg-white-light md:block
        ...
        >
          <div className="md:flex">
            ...
            >
              ...
              {cartItems?.map((item, index) => (
                <div key={index} className="sm:flex xs:flex-auto">
                  ...
                  sm:w-[72px] sm:h-[43px]
                  xs:w-[72px] xs:h-[35px]
                  xl:mt-[55px] lg:mt-[42px] md:mt-[40px] sm:mt-[35px] xs:mt-[-210px] lg:ml-[0px] md:ml-[-14px] xs:ml-[10px]"
                  >
                    <img
                      src={item?.image}
                      alt={item?.heading}
                  ...
                  <div className="sm:mt-[0px] lg:ml-[22px] sm:ml-[0px] xs:mt-[48px] xs:ml-[95px]">
                    ...
                    xl:pl-[34px] lg:pl-[20px] md:pl-[10px] sm:pl-[30px] xs:pl-[5px]
                  ...
                  <div className="sm:ml-[0px] xs:ml-[86px]">
                    <p
                      className="text-black-light 
                    xl:text-[16px] lg:text-[15px] md:text-[14px] sm:text-[12px] xs:text-[12px]
                    xl:pl-[80px] lg:pl-[73px] md:pl-[10px] sm:pl-[38px] xs:pl-[15px]
                    xl:pt-[100px] lg:pt-[75px] md:pt-[65px] sm:pt-[65px] xs:pt-[15px]
                    "
                    >
                      {item.price}
                    </p>
                  ...
                  md:pt-[65px]  md:pl-[7px]
                  sm:pt-[57px] sm:pl-[15px]
                  xs:pt-[15px] xs:pl-[19px] lg:ml-[0px] sm:ml-[12px] xs:ml-[81px]
                  "
                  >
                  ...
                  <div className=" sm:ml-[0px] xs:ml-[78px]">
                    ...
                    xl:text-[16px] lg:text-[15px] md:text-[14px] sm:text-[12px] xs:text-[12px]
                    xl:pl-[70px] lg:pl-[45px] md:pl-[20px] sm:pl-[19px] xs:pl-[18px]
                    xl:pt-[100px] lg:pt-[75px] md:pt-[65px] sm:pt-[65px] xs:pt-[15px]"
                    >
                  ...
                  sm:ml-[20px] sm:mt-[59px]
                  xs:ml-[200px] xs:mt-[-63px]
                  "
                  >
                    <img
            ...
            md:mt-[0px] sm:mt-[490px] xs:mt-[150px]
            bg-cream-bglight"
            >
              <h2
                className="
              ...
              <div className="flex">
                ...
                >
                  <p
                    className="text-black-light
                  lg:text-[16px] md:text-[15px] sm:text-[13px] xs:text-[16px] "
                  >
                    Rs.{subtotal}
                  </p>
                </div>
              ...
              text-black-darkest"
                ...
                >
                  ...
                  lg:text-[20px] md:text-[18px] sm:text-[12px] xs:text-[16px]"
                  >
                    Rs.{total}
                  </p>
                </div>
      ...
      <div className="font-poppins md:hidden">
        {cartItems.length === 0 ? (
          ...
          cartItems.map((item, index) => (
            <div
              key={index}
              className="bg-cream-bglight p-[16px] mb-[16px] mt-[20px] 
              rounded-lg shadow-md flex items-center sm:mx-[14px] sm:w-[450px]"
            >
              <div>
                <img
                  src={item?.image}
                  alt={item?.heading}
                  className="xs:w-[64px] xs:h-[69px] sm:w-[70px] sm:h-[75px] rounded-md"
                />
              </div>
              <div className=" sm:mx-[97px] xs:ml-[40px] mt-[1px] flex-grow">
                <p className="text-black-darkest font-semibold text-[18px]">
                  {item.heading}
                </p>
                <p className="text-gray-graymoney">{item.price}</p>
                <div className="flex items-center mt-[8px]">
                  <button
                    className="border rounded-md px-[8px]"
                    onClick={() =>
                      handleQuantityChange(item.id, item.quantity - 1)
                    }
                  >
                  ...
                  <p className="mx-[8px]">{item.quantity}</p>
                  <button
                    className="border rounded-md px-[8px]"
                    onClick={() =>
                      handleQuantityChange(item.id, item.quantity + 1)
              ...
              <div className=" text-center">
                <p className="text-black-darkest font-medium ">
                  {" "}
                  {`Rs. ${item.price.replace("Rp.", "") * item.quantity}`}
                </p>
                <img
                  ...
                  src={dust}
                  alt="distbn"
                  className="w-[20px] xs:mt-[8px] cursor-pointer"
                ></img>
              </div>
            </div>
          ))
        ...
        <div className="bg-cream-bglight p-[16px] rounded-lg shadow-md sm:mx-[14px] sm:my-[30px] sm:w-[450px]">
          ...
          <div className="flex justify-center items-center">
            <button
              className="mt-[8px] border border-black-darkest 
                      rounded-xl px-[32px] py-[10px]"
              onClick={handleClick}
            >
              {" "}
              {t("btn4")}
