  ...
  const data = [
    {
      ...
      subheading:" Our designer already made a lot of beautiful prototype of rooms that inspire you"
    },
    {
      numb:"01",
      head:"Bed Room",
          ...
          <div className="md:w-[45%] w-full relative">
            ...
            {posts.map((post,index)=>(
              ...
              bg-white-light opacity-70 absolute 
                ...
                ">
                 {post.numb} <img src={vectore} alt="arrow" className="mt-0" /> {post.head}
                </p>
                <h2 className="text-[28px] font-semibold mt-[-70px] ml-[32px]">{post.desc}</h2>
              </div>
