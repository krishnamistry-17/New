...
const Card = () => {
  ...
  return (
    <div
      className="relative bg-cover bg-center w-full h-[100vh]"
      style={{ backgroundImage: `url(${image})` }}
    >
      <div
        className="absolute right-5 md:right-8 lg:right-12    
   top-[135px] sm:top-[100px] md:top-[120px] lg:top-[135px] xl:top-[150px]"
      >
        <div
          className="bg-yellow-yelbg 
     max-w-[643px] h-auto
     ...
     xs:max-w-[300px]  xs:mt-[-17px]"
       ...
       font-medium pt-4  "
          ...
          <button
            className="bg-yellow-dark mt-7  bg-white text-white-light font-bold text-[16px]
