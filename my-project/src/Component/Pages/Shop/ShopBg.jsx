  ...
  return (
     <div className='relative w-full'>
           ...
           <div className=' absolute left-1/2 transform -translate-x-1/2 top-[120px] text-center'>
               <h2 className='font-medium md:text-[48px] xs:text-[30px] text-black-darkest'>Shop</h2>
               <div className=' absolute flex items-center justify-center '>
                   ...
                   <p className='md:text-[16px] xs:text-[12px] text-black-darkest pl-[6.08px]'>Shop</p>
               </div>
           </div>
       </div>
  )
