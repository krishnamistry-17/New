      ...
      <div className='mt-[30px]'>
        ...
        <div className='w-full h-auto '>
          ...
          gap-5 md:gap-4 px-4 sm:px-6 lg:px-8'>
            ...
            <div>
              <p className='text-black-light text-[16px] xs:text-[13px] pb-[15px]'>Links</p>
          ...
          <div>
            <p className='text-black-light text-[16px] xs:text-[13px] 
            pb-[15px]
            '>Newsletter</p>

            <div className='flex'>
              <div className='mr-[10px]'>
                <input type='text' placeholder='Enter Your Email Address' className='border-t-0 border-r-0 border-l-0 outline-none
                border-b-[3px] md:text-[14px] xs:text-[12px] text-black-light drop-shadow-sm'></input>
              </div>

              <div>
                <button className="border border-t-0 border-b-[3px] border-r-0 border-l-0 border-w-[75px]
          ...
          <div className='pt-[35px] flex flex-col items-center'>
            <hr className='w-full'/>
            <p className='md:text-[16px] xs:text-[12px] w-[239px] text-center'> 2023 Funiro. All rights reserved</p>
           </div>
